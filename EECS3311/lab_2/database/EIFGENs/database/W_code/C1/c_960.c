...
#define ui4_1 ui4_1x.it_i4
	...
	RTHOOK(8);
	RTDBGAA(Current, dtype, 5016, 0xF80000A3, 0); /* internal_item */
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(3172, Dtype(tr1)))(tr1, up1x, ui4_1x);
	RTNHOOK(8,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
