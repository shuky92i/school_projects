...
extern void F1166_10249(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1166_10250(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1166_10251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1166_10252(EIF_REFERENCE);
extern void F1166_10253(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1166_10254(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1166_10255(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1166_10256(EIF_REFERENCE);
...
/* {KL_STDERR_FILE}.make */
void F1166_10249 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1165, Current, 0, 0, 16813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1165, Current, 16813);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1166_10250 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1166_10250,16815,RTMS_EX_H("stderr",6,1911360114));
}
...
{
	GTCX
	RTOTC (F1166_10251,16816,RTMS_EX_H("\012",1,10));
}
...
void F1166_10253 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1165, Current, 0, 1, 16817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1165, Current, 16817);
	RTIV(Current, RTAL);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1165, Current, 1, 1, 16818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1166_10255 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1165, Current, 0, 0, 16819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F1166_10256)
EIF_TYPED_VALUE F1166_10256 (EIF_REFERENCE Current)
{
	GTCX
...
{
	GTCX
	RTOTS (10250,F1166_10250)
	RTOTS (10251,F1166_10251)
	RTOTS (10256,F1166_10256)
}
