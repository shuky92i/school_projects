...
extern void F1157_10198(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1157_10199(EIF_REFERENCE);
extern void F1157_10200(EIF_REFERENCE);
extern void F1157_10201(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1157_10202(EIF_REFERENCE);
extern void F1157_10203(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1157_10204(EIF_REFERENCE);
...
extern void F1157_10212(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1157_10213(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1157_10214(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1157_10215(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 16764);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16764);
	RTCC(arg1, 1156, l_feature_name, 1, eif_new_type(1247, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7777, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 16765);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16765);
	RTCC(arg1, 1156, l_feature_name, 1, RTWCT(7786, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7786, 0xF8000546, 0); /* pixel_buffer */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7786, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7785, 0xF80003CA, 0); /* internal_item */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7785, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(3,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7786, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6165, "set_pixel_buffer", tr1))(tr1, ur1x);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7781, 0x38000000, 1); /* max_row_value */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9474, "height", arg1))(arg1)).it_i4);
	RTNHOOK(4,1);
	tu4_1 = (EIF_NATURAL_32) ti4_1;
	*(EIF_NATURAL_32 *)(Current + RTWA(7781, dtype)) = (EIF_NATURAL_32) tu4_1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7780, 0x38000000, 1); /* max_column_value */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9473, "width", arg1))(arg1)).it_i4);
	RTNHOOK(5,1);
	tu4_1 = (EIF_NATURAL_32) ti4_1;
...
void F1157_10198 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 16766);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7778, 0x38000000, 1); /* column */
	*(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype)) = (EIF_NATURAL_32) (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7779, 0x38000000, 1); /* row */
...
EIF_TYPED_VALUE F1157_10199 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 16746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16746);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1157_10200 (EIF_REFERENCE Current)
{
	GTCX
	...
	*(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype)) = (EIF_NATURAL_32) tu4_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
body:;
	RTHOOK(3);
	tu4_1 = *(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype));
	...
	if ((EIF_BOOLEAN)(tu4_1 == tu4_2)) {
		...
		*(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype)) = (EIF_NATURAL_32) (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L);
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 7778, 0x38000000, 1); /* column */
		(*(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype))) += (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
...
EIF_TYPED_VALUE F1157_10202 (EIF_REFERENCE Current)
{
	GTCX
...
void F1157_10203 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1157_10204 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	if (tb1) {
		...
		tu4_2 = *(EIF_NATURAL_32 *)(Current + RTWA(7779, dtype));
		uu4_2 = (EIF_NATURAL_32) (tu4_2 - (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L));
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6166, "sync_with_pixel_buffer_value", Result))(Result, uu4_1x, uu4_2x);
	} else {
		RTHOOK(6);
		RTDBGAL(0, 0xF80003CA, 0,0); /* Result */
...
EIF_TYPED_VALUE F1157_10205 (EIF_REFERENCE Current)
{
	...
	tu4_1 = *(EIF_NATURAL_32 *)(Current + RTWA(7779, dtype));
	tu4_2 = *(EIF_NATURAL_32 *)(Current + RTWA(7780, dtype));
	tu4_3 = *(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype));
...
EIF_TYPED_VALUE F1157_10206 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
	r.it_n4 = *(EIF_NATURAL_32 *)(Current + RTWA(7778,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 16755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16755);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1157_10211 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 16758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16758);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1157_10212 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 16759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16759);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7778, 0x38000000, 1); /* column */
	*(EIF_NATURAL_32 *)(Current + RTWA(7778, dtype)) = (EIF_NATURAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 16760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1157_10214 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uu4_2 uu4_2x.it_n4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 3, 16761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1156, Current, 16761);
	RTCC(arg3, 1156, l_feature_name, 3, eif_new_type(970, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("a_column_valid", EX_PRE);
...
body:;
	...
	if (tb1) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7786, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6165, "set_pixel_buffer", arg3))(arg3, ur1x);
		RTHOOK(5);
		uu4_1 = (EIF_NATURAL_32) (arg1 - (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L));
		uu4_2 = (EIF_NATURAL_32) (arg2 - (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L));
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6166, "sync_with_pixel_buffer_value", arg3))(arg3, uu4_1x, uu4_2x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
EIF_TYPED_VALUE F1157_10215 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
