...
void F1165_10242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1164, Current, 0, 1, 16805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1164, Current, 16805);
	RTCC(arg1, 1164, l_feature_name, 1, RTWCT(7810, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7810, 0xF80000E8, 0); /* name */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7810, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1164, Current, 0, 1, 16806);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1164, Current, 16806);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1165_10245 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
{
	GTCX
	RTOTC (F1165_10247,16811,RTMS_EX_H("\012",1,10));
}

/* {KL_NULL_TEXT_OUTPUT_STREAM}.flush */
void F1165_10248 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1164, Current, 0, 0, 16811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1164, Current, 16811);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_write", EX_PRE);
...
void F1165_16452 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1164, Current, 0, 16451);
	RTSA(dtype);
	RTME(dtype, 0);
	RTLO(2);
	RTMD(0);
