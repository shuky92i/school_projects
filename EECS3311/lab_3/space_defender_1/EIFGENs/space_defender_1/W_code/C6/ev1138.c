...
extern void F1138_10137(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1138_10138(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1138_10139(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1138_10140(EIF_REFERENCE);
extern void F1138_10141(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1138_10142(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1138_10137 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1137, Current, 1, 1, 16688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1137, Current, 16688);
	if (arg1) {
		{
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		switch (ti4_1) {
			case 1L:
				...
				ur1 = RTCCL(tr3);
				tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7756, dtype))(Current, ur1x)).it_b);
				if (tb1) {
					RTHOOK(4);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 0, 1, 16689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7754, 0xF8000114, 0); /* veto_pebble_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1138_10139 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 2, 1, 16690);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1138_10140 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1138_10141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 0, 2, 16692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1137, Current, 16692);
	{
...
EIF_TYPED_VALUE F1138_10142 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 2, 1, 16693);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
