...
static EIF_TYPED_VALUE F1490_14725_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1490_14725_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1490_14725 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1490_14725_body (Current)).it_r;
