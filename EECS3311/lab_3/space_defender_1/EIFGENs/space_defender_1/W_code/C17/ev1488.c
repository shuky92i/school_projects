...
extern void F1488_14713(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1488_14714(EIF_REFERENCE);
extern void F1488_14715(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1488_14716(EIF_REFERENCE);
extern void F1488_14717(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1488_14718(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1488_14719_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1488_14719(EIF_REFERENCE);
...
void F1488_14713 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x, EIF_TYPED_VALUE arg8x, EIF_TYPED_VALUE arg9x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1487, Current, 1, 9, 20910);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20910);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1488_14714 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1487, Current, 0, 0, 20911);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20911);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_ITEM_IMP}.destroy */
void F1488_14715 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1487, Current, 1, 0, 20912);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20912);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
...
EIF_TYPED_VALUE F1488_14716 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1488_14717 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1487, Current, 0, 1, 20914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20914);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {1575,0xFF01,1312,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
			
			typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
			RTCC(arg1, 1487, l_feature_name, 1, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10893, 0xF8000627, 0); /* item_parent_imp */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1488_14718 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1487, Current, 0, 1, 20915);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20915);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1488_14719_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1487, Current, 0, 0, 20916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1487, Current, 20916);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1488_14719 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1488_14719_body (Current)).it_r;
