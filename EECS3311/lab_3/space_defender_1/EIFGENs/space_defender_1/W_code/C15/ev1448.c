...
extern void F1448_13987(EIF_REFERENCE);
static EIF_TYPED_VALUE F1448_13991_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1448_13991(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1448_13987 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1447, Current, 0, 0, 20295);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1448_13991_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1447, Current, 0, 0, 20296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1448_13991 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1448_13991_body (Current)).it_r;
