...
extern void F1429_13657(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1429_13658(EIF_REFERENCE);
static EIF_TYPED_VALUE F1429_13659_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1429_13659(EIF_REFERENCE);
...
void F1429_13657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1428, Current, 0, 1, 20039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1428, Current, 20039);
	RTCC(arg1, 1428, l_feature_name, 1, RTWCT(9339, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1429_13658 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1428, Current, 0, 0, 20040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1429_13659_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1428, Current, 0, 0, 20041);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1429_13659 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1429_13659_body (Current)).it_r;
