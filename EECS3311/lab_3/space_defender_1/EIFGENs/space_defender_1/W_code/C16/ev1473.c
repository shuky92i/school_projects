...
#define ur1 ur1x.it_r
	...
	*(EIF_REFERENCE *)(Current + RTWA(10779, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10780, 0xF8000171, 0); /* temp_pebble_function */
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		RTHOOK(11);
		ui4_1 = arg2;
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8788, "text", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr2);
