...
extern void F1459_14069(EIF_REFERENCE);
static EIF_TYPED_VALUE F1459_14070_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14070(EIF_REFERENCE);
extern void F1459_16519(EIF_REFERENCE, int);
...
void F1459_14069 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1459_14070_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1459_14070 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1459_14070_body (Current)).it_r;
...
void F1459_16519 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1458, Current, 0, 16518);
	RTSA(dtype);
	RTME(dtype, 0);
