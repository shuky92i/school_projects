...
extern EIF_TYPED_VALUE F1480_14590(EIF_REFERENCE);
static EIF_TYPED_VALUE F1480_14593_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1480_14593(EIF_REFERENCE);
...
/* {EV_ITEM_I}.parent */
EIF_TYPED_VALUE F1480_14590 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1479, Current, 1, 0, 20793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1479, Current, 20793);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1571,0xFF01,1312,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1480_14593_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1479, Current, 0, 0, 20794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1479, Current, 20794);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1480_14593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1480_14593_body (Current)).it_r;
