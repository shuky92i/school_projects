...
extern EIF_TYPED_VALUE F1317_12016(EIF_REFERENCE);
extern void F1317_12017(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1317_12016 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1317_12017 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1316, Current, 0, 0, 18699);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1316, Current, 18699);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8410, 0xF80005CA, 0); /* implementation */
