...
extern EIF_TYPED_VALUE F1306_11892(EIF_REFERENCE);
extern void F1306_11893(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1306_11892 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1306_11893 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1305, Current, 0, 0, 18575);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1305, Current, 18575);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8410, 0xF80005AC, 0); /* implementation */
