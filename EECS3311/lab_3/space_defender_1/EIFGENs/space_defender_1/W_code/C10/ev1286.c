...
extern EIF_TYPED_VALUE F1286_11614(EIF_REFERENCE);
extern void F1286_11615(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1286_11614 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1286_11615 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1285, Current, 0, 0, 18296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1285, Current, 18296);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8410, 0xF8000591, 0); /* implementation */
