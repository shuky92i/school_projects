...
extern EIF_TYPED_VALUE F1625_6499(EIF_REFERENCE);
extern void F1625_6500(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1625_6501(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1625_6502(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1625_6503(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1625_6504(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1625_6505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1625_6506(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1625_6507(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1625_6508(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F1625_6508
static EIF_INTEGER_32 inline_F1625_6508 (EIF_POINTER arg1, EIF_POINTER arg2, EIF_POINTER arg3, EIF_POINTER arg4, EIF_INTEGER_32 arg5, EIF_BOOLEAN arg6, EIF_INTEGER_32 arg7, EIF_INTEGER_32 arg8, EIF_INTEGER_32 arg9, EIF_POINTER arg10)
{
	#ifdef WORKBENCH
...
EIF_TYPED_VALUE F1625_6499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
/* {FUNCTION}.call */
void F1625_6500 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1624, Current, 0, 1, 17508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17508);
	RTCC(arg1, 1624, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
...
/* {FUNCTION}.item */
EIF_TYPED_VALUE F1625_6501 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1624, Current, 1, 1, 17509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17509);
	RTCC(arg1, 1624, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
...
/* {FUNCTION}.apply */
void F1625_6502 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1624, Current, 0, 0, 17510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17510);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
/* {FUNCTION}.is_equal */
EIF_TYPED_VALUE F1625_6503 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1624, Current, 0, 1, 17511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17511);
	RTCC(arg1, 1624, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tb1 = '\0';
	ur1 = RTCCL(arg1);
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11, 258))(Current, ur1x)).it_b);
	if (tb2) {
...
/* {FUNCTION}.copy */
void F1625_6504 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1624, Current, 0, 1, 17512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17512);
	RTCC(arg1, 1624, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (!RTCEQ(arg1, Current)) {
		RTHOOK(4);
		ur1 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18, 258))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
/* {FUNCTION}.eval */
EIF_TYPED_VALUE F1625_6505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1624, Current, 0, 1, 17513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17513);
	RTCC(arg1, 1624, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x02);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
void F1625_6506 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1624, Current, 1, 0, 17514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17514);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
EIF_TYPED_VALUE F1625_6507 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1624, Current, 2, 1, 17515);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1624, Current, 17515);
	if (arg1) {
		{
			...
			RTCC(arg1, 1624, l_feature_name, 1, typres0, 0x04);
		}
	}
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
...
/* {FUNCTION}.fast_item */
EIF_TYPED_VALUE F1625_6508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x, EIF_TYPED_VALUE arg8x, EIF_TYPED_VALUE arg9x, EIF_TYPED_VALUE arg10x)
{
	GTCX
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1624, Current, 0, 10, 17516);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1624, Current, 17516);
	RTIV(Current, RTAL);
	Result = inline_F1625_6508 ((EIF_POINTER) arg1, (EIF_POINTER) arg2, (EIF_POINTER) arg3, (EIF_POINTER) arg4, (EIF_INTEGER_32) arg5, (EIF_BOOLEAN) arg6, (EIF_INTEGER_32) arg7, (EIF_INTEGER_32) arg8, (EIF_INTEGER_32) arg9, (EIF_POINTER) arg10);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
