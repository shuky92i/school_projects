...
static EIF_TYPED_VALUE F1377_13084_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1377_13084_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1376, Current, 0, 0, 19598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1376, Current, 19598);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1377_13084 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9339, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1377_13084_body (Current)).it_r;
