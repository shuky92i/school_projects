...
extern EIF_TYPED_VALUE F1541_15621(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1541_15622(EIF_REFERENCE);
extern void F1541_15623(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1541_15621 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1541_15622 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1541_15623 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1540, Current, 0, 0, 21680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1540, Current, 21680);
	RTIV(Current, RTAL);
