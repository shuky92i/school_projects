...
extern EIF_TYPED_VALUE F1004_8660(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8661(EIF_REFERENCE);
static EIF_TYPED_VALUE F1004_8662_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8662(EIF_REFERENCE);
extern void F1004_8663(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1004_8664_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8664(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1004_8660 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 15000);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 15000);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6449, 0xF8000482, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1004_8661 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 15001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6451, 0xF8000482, 0); /* drop_down_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1004_8662_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 15002);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 15002);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1004_8662 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6449, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1004_8662_body (Current)).it_r;
...
void F1004_8663 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1003, Current, 0, 1, 15003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 15003);
	RTCC(arg1, 1003, l_feature_name, 1, RTWCT(6447, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1004_8664_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 15004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 15004);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1004_8664 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6451, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1004_8664_body (Current)).it_r;
