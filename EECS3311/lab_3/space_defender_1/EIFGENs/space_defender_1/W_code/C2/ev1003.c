...
EIF_TYPED_VALUE F1003_8659 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 14999);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14999);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11006, "horizontal_resolution", loc1))(loc1)).it_i4);
	RTNHOOK(2,1);
