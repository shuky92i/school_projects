...
extern EIF_TYPED_VALUE F1118_9818(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1118_9818 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1117, Current, 0, 0, 16067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1117, Current, 16067);
	RTIV(Current, RTAL);
