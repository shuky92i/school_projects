...
extern EIF_TYPED_VALUE F1117_9817(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1117_9817 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1116, Current, 0, 0, 16066);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1116, Current, 16066);
	RTIV(Current, RTAL);
