...
extern EIF_TYPED_VALUE F1191_10449(EIF_REFERENCE);
...
RTOID (F1191_10449)
EIF_TYPED_VALUE F1191_10449 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1190, Current, 0, 0, 17059);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1190, Current, 17059);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
