...
extern EIF_TYPED_VALUE F1149_10249(EIF_REFERENCE);
...
RTOID (F1149_10249)
EIF_TYPED_VALUE F1149_10249 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1148, Current, 0, 0, 16503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1148, Current, 16503);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
