...
extern EIF_TYPED_VALUE F1141_10116(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1141_10116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1140, Current, 0, 0, 16373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1140, Current, 16373);
	RTIV(Current, RTAL);
