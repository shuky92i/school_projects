...
extern EIF_TYPED_VALUE F1142_10117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1142_10117 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1141, Current, 0, 0, 16374);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1141, Current, 16374);
	RTIV(Current, RTAL);
