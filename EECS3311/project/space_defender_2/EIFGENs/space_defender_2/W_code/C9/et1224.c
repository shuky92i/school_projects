...
extern void F1224_10783(EIF_REFERENCE);
...
/* {ETF_FIRE}.fire */
void F1224_10783 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1223, Current, 0, 0, 17354);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1223, Current, 17354);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6537, "fire", tr1))(tr1);
	RTHOOK(2);
