...
extern EIF_TYPED_VALUE F1227_10834(EIF_REFERENCE);
...
RTOID (F1227_10834)
EIF_TYPED_VALUE F1227_10834 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1226, Current, 0, 0, 17457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1226, Current, 17457);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
