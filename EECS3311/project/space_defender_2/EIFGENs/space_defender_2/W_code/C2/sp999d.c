/*
 * Class reference SPACEWAR_ACCESS
 */
...
static const EIF_TYPE_INDEX egt_1_999 [] = {0xFF01,1625,998,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,999,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_14_999), 15092, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 383, 998);
}
