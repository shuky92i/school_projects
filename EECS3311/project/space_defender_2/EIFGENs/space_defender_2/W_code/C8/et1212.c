...
extern void F1212_10761(EIF_REFERENCE);
...
/* {ETF_SPECIAL}.special */
void F1212_10761 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1211, Current, 0, 0, 17338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1211, Current, 17338);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6539, "special", tr1))(tr1);
	RTHOOK(2);
