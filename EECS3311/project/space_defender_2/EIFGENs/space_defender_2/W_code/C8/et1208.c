...
extern void F1208_10755(EIF_REFERENCE);
...
/* {ETF_PASS}.pass */
void F1208_10755 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1207, Current, 0, 0, 17334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6535, "pass", tr1))(tr1);
	RTHOOK(2);
