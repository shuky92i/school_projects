/*
 * Code for class ETF_TOGGLE_DEBUG_MODE
 */
...
extern void F1214_10764(EIF_REFERENCE);
...
/* {ETF_TOGGLE_DEBUG_MODE}.toggle_debug_mode */
void F1214_10764 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1213, Current, 0, 0, 17340);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1213, Current, 17340);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6540, "toggle_debug_mode", tr1))(tr1);
	RTHOOK(2);
