...
extern void F1210_10758(EIF_REFERENCE);
...
/* {ETF_ABORT}.abort */
void F1210_10758 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1209, Current, 0, 0, 17336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1209, Current, 17336);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6538, "abort", tr1))(tr1);
	RTHOOK(2);
