/*
 * Code for class ETF_SETUP_BACK_INTERFACE
 */
...
extern void F1221_10777(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1221_10778(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1221(void);
extern EIF_REFERENCE _A1221_68_2();
...
/* {ETF_SETUP_BACK_INTERFACE}.make */
void F1221_10777 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1220, Current, 1, 3, 17350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1220, Current, 17350);
	RTCC(arg1, 1220, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1220, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1220, l_feature_name, 3, eif_new_type(1054, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1221_68_2, (EIF_POINTER)(0),8270, tr2, 0, 1, -1, tr1, 1);
	}
	tr1 = RTCCL(tr4);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(8246, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (tb1) {
		...
		tr1 = RTMS_EX_H("setup_back(",11,1770553128);
		tr2 = RTMS_EX_H("setup_back",10,1449754219);
		ur1 = tr2;
		tr3 = RTMS_EX_H("state",5,1953427045);
		ur2 = tr3;
...
/* {ETF_SETUP_BACK_INTERFACE}.setup_back_precond */
EIF_TYPED_VALUE F1221_10778 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "setup_back_precond";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1220, Current, 0, 1, 17351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1220, Current, 17351);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7393, dtype))(Current, ui4_1x)).it_b);
	Result = (EIF_BOOLEAN) tb1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("Result = is_state(state)", EX_POST);
		ui4_1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7393, dtype))(Current, ui4_1x)).it_b);
