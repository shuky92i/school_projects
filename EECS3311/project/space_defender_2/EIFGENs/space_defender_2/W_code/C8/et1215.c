/*
 * Code for class ETF_SETUP_NEXT_INTERFACE
 */
...
extern void F1215_10765(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1215_10766(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1215(void);
extern EIF_REFERENCE _A1215_68_2();
...
/* {ETF_SETUP_NEXT_INTERFACE}.make */
void F1215_10765 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1214, Current, 1, 3, 17341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1214, Current, 17341);
	RTCC(arg1, 1214, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1214, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1214, l_feature_name, 3, eif_new_type(1054, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1215_68_2, (EIF_POINTER)(0),8264, tr2, 0, 1, -1, tr1, 1);
	}
	tr1 = RTCCL(tr4);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(8246, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (tb1) {
		...
		tr1 = RTMS_EX_H("setup_next(",11,1839132712);
...
/* {ETF_SETUP_NEXT_INTERFACE}.setup_next_precond */
EIF_TYPED_VALUE F1215_10766 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "setup_next_precond";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1214, Current, 0, 1, 17342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1214, Current, 17342);
	RTIV(Current, RTAL);
	RTHOOK(1);
