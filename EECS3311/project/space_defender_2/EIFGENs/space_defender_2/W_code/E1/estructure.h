...
struct eif_ex_345 {union overhead overhead; char data [8];};
struct eif_ex_469 {union overhead overhead; char data [8];};
struct eif_ex_473 {union overhead overhead; char data [8];};
struct eif_ex_477 {union overhead overhead; char data [8];};
struct eif_ex_481 {union overhead overhead; char data [8];};
struct eif_ex_485 {union overhead overhead; char data [8];};
struct eif_ex_491 {union overhead overhead; char data [8];};
struct eif_ex_495 {union overhead overhead; char data [8];};
struct eif_ex_499 {union overhead overhead; char data [8];};
struct eif_ex_510 {union overhead overhead; char data [8];};
struct eif_ex_514 {union overhead overhead; char data [8];};
struct eif_ex_608 {union overhead overhead; char data [8];};
struct eif_ex_634 {union overhead overhead; char data [8];};
struct eif_ex_944 {union overhead overhead; char data [8];};
struct eif_ex_983 {union overhead overhead; char data [1];};
struct eif_ex_988 {union overhead overhead; char data [1];};
struct eif_ex_990 {union overhead overhead; char data [1];};
struct eif_ex_994 {union overhead overhead; char data [1];};
struct eif_ex_997 {union overhead overhead; char data [1];};
struct eif_ex_1224 {union overhead overhead; char data [16];};
