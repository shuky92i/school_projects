...
extern void F1465_14042(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1465_14043(EIF_REFERENCE);
static EIF_TYPED_VALUE F1465_14044_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1465_14044(EIF_REFERENCE);
...
void F1465_14042 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1464, Current, 0, 1, 20559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1464, Current, 20559);
	RTCC(arg1, 1464, l_feature_name, 1, RTWCT(9683, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1465_14043 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1464, Current, 0, 0, 20557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1464, Current, 20557);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10711, dtype))(Current)).it_b);
	ub1 = tb1;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9678, 1462))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1465_14044_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1464, Current, 0, 0, 20558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1464, Current, 20558);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1465_14044 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9683, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1465_14044_body (Current)).it_r;
