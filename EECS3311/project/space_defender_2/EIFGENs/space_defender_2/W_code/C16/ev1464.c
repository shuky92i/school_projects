...
extern void F1464_14039(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1464_14040(EIF_REFERENCE);
static EIF_TYPED_VALUE F1464_14041_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1464_14041(EIF_REFERENCE);
...
void F1464_14039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1463, Current, 0, 1, 20554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20554);
	RTCC(arg1, 1463, l_feature_name, 1, RTWCT(9683, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1464_14040 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1463, Current, 0, 0, 20555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20555);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1464_14041_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1463, Current, 0, 0, 20556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20556);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1464_14041 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9683, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1464_14041_body (Current)).it_r;
