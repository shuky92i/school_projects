...
extern EIF_TYPED_VALUE F1066_9339(EIF_REFERENCE);
...
RTOID (F1066_9339)
EIF_TYPED_VALUE F1066_9339 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1065, Current, 0, 0, 15646);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1065, Current, 15646);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
