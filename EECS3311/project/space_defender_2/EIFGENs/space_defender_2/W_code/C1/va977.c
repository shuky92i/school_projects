...
extern void F977_8455(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_8456(EIF_REFERENCE);
extern void F977_8457(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F977_8455 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6244, 0x800004C8, 1); /* epsilon */
	...
	RTNHOOK(1,1);
	tr1 = RTRCL(tr1);
	RTXA(tr1, (Current + RTWA(6244, dtype)));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F977_8456 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = (Current + RTWA(6244,Dtype(Current)));
	return r;
}


/* {VALUE_SINGLETON}.set_epsilon */
void F977_8457 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 976, Current, 0, 1, 14757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
