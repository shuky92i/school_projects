/*
 * Code for class reference RANDOM_GENERATOR_ACCESS
 */
...
extern EIF_TYPED_VALUE F985_8586(EIF_REFERENCE);
extern EIF_TYPED_VALUE F985_8587(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F985_16822(EIF_REFERENCE, int);
...
RTOID (F985_8586)
EIF_TYPED_VALUE F985_8586 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 14892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(984, Current, 14892);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F985_8587 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 984, Current, 2, 2, 14890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(984, Current, 14890);
	RTIV(Current, RTAL);
...
void F985_16822 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 984, Current, 0, 16821);
	RTSA(dtype);
	RTME(dtype, 0);
