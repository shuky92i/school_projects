...
extern EIF_TYPED_VALUE F1033_8975(EIF_REFERENCE);
static EIF_TYPED_VALUE F1033_8976_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1033_8976(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1033_8975 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 15302);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 15302);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6752, 0xF8000496, 0); /* docked_actions_internal */
		tr1 = RTLNSMART(RTWCT(6752, dtype, Dftype(Current)).id);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
		RTNHOOK(2,1);
		tr1 = RTCCL(tr1);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6752, dtype)) = (EIF_REFERENCE) tr1;
	}
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1033_8976_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 15303);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 15303);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1033_8976 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6752, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1033_8976_body (Current)).it_r;
