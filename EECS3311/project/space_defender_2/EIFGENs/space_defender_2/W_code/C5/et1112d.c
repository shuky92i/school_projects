...
static const EIF_TYPE_INDEX egt_14_1112 [] = {0xFF01,253,0xFF01,1110,0xFFFF};
...
static const struct desc_info desc_1112[] = {
	...
	{EIF_GENERIC(egt_13_1112), 15979, 0},
	{EIF_GENERIC(NULL), 15980, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1112), 15981, 8},
};
void Init1112(void)
{
	IDSC(desc_1112, 0, 1111);
	IDSC(desc_1112 + 1, 1, 1111);
	IDSC(desc_1112 + 32, 390, 1111);
	IDSC(desc_1112 + 34, 436, 1111);
}
