...
extern EIF_TYPED_VALUE F1562_15708(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1562_15708 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1561, Current, 0, 0, 21959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1561, Current, 21959);
	RTIV(Current, RTAL);
	RTHOOK(1);
