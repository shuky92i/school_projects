...
extern EIF_TYPED_VALUE F1658_9422(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1658_9423(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1658_9425(EIF_REFERENCE);
extern void F1658_9430(EIF_REFERENCE);
extern void F1658_9431(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1658_9422 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1657, Current, 2, 3, 15715);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1657, Current, 15715);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1658,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(7195, dtype, Dftype(Current));
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(12);
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7192, dtype))(Current)).it_c1);
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6895, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F1658_9423 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1657, Current, 0, 0, 15716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1657, Current, 15716);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1658_9425 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1657, Current, 0, 0, 15712);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1657, Current, 15712);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F1658_9430 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1657, Current, 0, 0, 15713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1657, Current, 15713);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1658_9431 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1657, Current, 0, 0, 15714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1657, Current, 15714);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
