...
extern void F1185_10565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1185_10566(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1185_10567(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1185(void);
extern EIF_REFERENCE _A1185_183();
...
void F1185_10565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1184, Current, 0, 1, 17131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1184, Current, 17131);
	{
		...
		RTCC(arg1, 1184, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
...
void F1185_10566 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1184, Current, 0, 1, 17132);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1184, Current, 17132);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,254,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1185_183, (EIF_POINTER)(0),8112, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1185_10567 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1184, Current, 0, 1, 17133);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1184, Current, 17133);
	RTIV(Current, RTAL);
