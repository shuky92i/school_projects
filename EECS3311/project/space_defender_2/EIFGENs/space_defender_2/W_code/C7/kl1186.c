...
extern EIF_TYPED_VALUE F1186_10568(EIF_REFERENCE);
...
RTOID (F1186_10568)
EIF_TYPED_VALUE F1186_10568 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1185, Current, 0, 0, 17134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1185, Current, 17134);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
