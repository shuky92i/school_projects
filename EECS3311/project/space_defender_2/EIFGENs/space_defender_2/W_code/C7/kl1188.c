...
extern EIF_TYPED_VALUE F1188_10590(EIF_REFERENCE);
...
RTOID (F1188_10590)
EIF_TYPED_VALUE F1188_10590 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1187, Current, 0, 0, 17175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1187, Current, 17175);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
