...
extern EIF_TYPED_VALUE F1436_13657(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1436_13657 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 20252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20252);
	RTIV(Current, RTAL);
	RTHOOK(1);
